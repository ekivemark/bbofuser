...
from accounts.views.other import (Application_Detail)

from accounts.views.sms import (sms_code,
                                sms_login)
from accounts.views.user import user_edit
from accounts.views.organization import (Application_EditForm)
...
urlpatterns = patterns('',
   ...
   url(r'^application/edit/(?P<pk>[-\w]+)/$', 'accounts.views.organization.application_edit',
